...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="standardmetricthroughput" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" io.pcp.parfait.benchmark.StandardMetricThroughPutBenchmark %CMD_LINE_ARGS%
